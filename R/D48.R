...
#' @param eq Defines the equation used for the calculation. Options are *"Swart21"* and *"Fiebig21"*.
...
#' @param kinetic_slope Kinetic slope. Either -0.6 or +1.
#' @return
...
temp_D48 = function(D47_CDES90, D48_CDES90, kinetic_slope) {
line1 = data.frame(x=c(D48_CDES90+1, D48_CDES90-1), y=c(D47_CDES90+1*kinetic_slope, D47_CDES90-1*kinetic_slope))
line2 = data.frame(x=D48(seq(-5,500,0.1)),               y=D47(seq(-5,500,0.1)))
