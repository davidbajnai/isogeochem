# Datasets that can be called in isogeochem are described in this file
# "devilshole", "LR04"
...
#'
#' @references
#' Winograd, I. J., Landwehr, J. M., Coplen, T. B., Sharp, W. D., Riggs, A. C., Ludwig, K. R., & Kolesar, P. T. (2006).
...
#' \describe{
#'   \item{age}{Interpolated uranium-series age of the sample expressed as thousands of years before present (ka).}
...
#' \describe{
#'   \item{age}{Age of the sample expressed as thousands of years before present (ka).}
...
#' @title Oxygen isotope stratigraphy from the Geologic Time Scale 2020: macrofossils
#'
#' @description A dataset containing a compilation of d18O and d13C values of various macrofossils
#'   (bivalves, gastropods, belemnites, ammonites) together with
#'   information on their age, shell mineralogy, and the climate zone they represent.
#'   This dataset is a condensed version of the entire dataset presented in the
#'   Geologic Time Scale 2020. Specifically, the full dataset was filtered for those "select" d18O and d13C values
#'   that also have age information.
#'
#' @source \url{https://download.pangaea.de/dataset/930093/files/GTS2020-App_10.2A.xlsx}
#'
#' @references
#' Grossman, E. L., & Joachimski, M. M. (2020).
#' Oxygen isotope stratigraphy.
#' In F. M. Gradstein, J. G. Ogg, M. D. Schmitz, & G. M. Ogg (Eds.), Geologic Time Scale 2020: Volume 1 (pp. 279-307): Elsevier.
#' <https://doi.org/10.1016/B978-0-12-824360-2.00010-3>
#'
#' @format A data frame with 9676 rows and 8 variables:
#' \describe{
#'   \item{age}{Age of the sample expressed as millions of years before present (Ma).}
#'   \item{d18O_VPDB}{Carbonate d18O value relative to VPDB (per mille).}
