...
plot(0, type = "l" , las = 1, xaxs = "i", yaxs = "i", xaxt = "n", 
     ylim = c(-17.5,-14.5),  xlim = c(0, 570),
...
# Plot the results
par(mar = c(4, 4.3, 0.5, 0.8))
plot(0, type = "l", ylim = c(28, 38), xlim = c(0, 570), 
     xaxs = "i", yaxs = "i", xaxt = "n",  las = 1,
     ylab = "Temperature (°C)",
     xlab = "Age (ka)")
...
# Plot the results
par(mar = c(4.1, 4.4, 0.5, 0.8))
plot(0, type = "l", ylim = c(-16, -12), xlim = c(0, 570),
     xaxs = "i", yaxs = "i", xaxt = "n", las = 1,
