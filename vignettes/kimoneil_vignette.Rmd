...
# lines(temp, 1000 * log(a18_c_H2O(temp, "calcite", "KO97-orig")), col = "darkblue", lwd = 2, lty = 2)
lines(temp, 1000 * log(a18_c_H2O(temp, "calcite", "KO97")), col = "darkblue", lwd = 2, lty = 1)

lines(temp, 1000 * log(a18_c_H2O(temp, "calcite", "Daeron19")), col = "purple", lwd = 1)
lines(temp, 1000 * log(a18_c_H2O(temp, "calcite", "Coplen07")), col = "red", lwd = 1)
lines(temp, 1000 * log(a18_c_H2O(temp, "calcite", "Watkins13")), col = "magenta", lwd = 1)
lines(temp, 1000 * log(a18_c_H2O(temp, "calcite", "FO77")), col = "green", lwd = 1)
lines(temp, 1000 * log(a18_c_H2O(temp, "calcite", "Tremaine11")), col = "lightblue", lwd = 1)
```
