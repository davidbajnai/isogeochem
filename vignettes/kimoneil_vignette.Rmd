...
The data is from Table 1 in Kim and O'Neil (1997). They used data only where the initial concentration of Ca<sup>2+</sup> and HCO<sub>3</sub><sup>–</sup> was 5 mM. All *δ*<sup>18</sup>O values are expressed on the VSMOW scale.
...
plot(0, type = "l", ylim = c(28, 34), xlim = c(10, 30), las = 1,
